  ...
  return (
    <footer className="mt-auto bg-gray-900 w-full dark:bg-neutral-950">
      <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          >
            <span className="inline-flex items-center gap-x-2 text-xl font-semibold">
              <img
                ...
                alt="Logo"
              />
              <p className="text-white">Cric Opinion</p>
            </span>
          </motion.div>
          ...
          >
            ...
            <div className="mt-3 grid space-y-3">
              <p>
                <a
                  className="inline-flex gap-x-2 text-gray-400 hover:text-green-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                  href="#why-cric-opinion"
                >
                  Why Cric Opinion??
                </a>
              </p>
          ...
          >
            <h4 className="font-semibold text-gray-100">How To Play</h4>
            <div className="mt-3 grid space-y-3">
              <p>
                <a
                  className="inline-flex gap-x-2 text-gray-400 hover:text-green-200 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
          ...
          >
            <h4 className="font-semibold text-gray-100">Download our App</h4>
            <div className="mt-3 grid space-y-3">
              <a href="/">
                <img
          ...
          {/* Memberships & Associations Section */}
          <motion.div
            className="col-span-1"
            variants={footerVariants}
            initial="hidden"
          ...
          >
            ...
            <div className="mt-3 grid space-y-3">
              <span className="inline-flex items-center gap-x-2 text-xl font-semibold mt-8">
                <img
                  className="w-10 h-auto rounded-full"
                  src="https://ih1.redbubble.net/image.2062244241.1768/fposter,small,wall_texture,square_product,600x600.jpg"
                  alt="Logo"
            ...
            <div className="mt-3 grid space-y-3">
              <a href="/">
                <img src="" className="w-48 h-13" alt="ISO" />
              </a>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center"
          variants={footerVariants}
          initial="hidden"
          whileInView="visible"
          transition={{ delay: 1 }}
